...
import img1 from "@/main/management.png";
import img2 from "@/main/behavior.png";
import img3 from "@/main/decision_making.png";
import img4 from "@/main/responsibility.png";
import img5 from "@/main/skills.png";
import img6 from "@/main/social_awareness.png";
import img7 from "@/main/self_awareness.png";
import img8 from "@/main/thinking.png";
import innerLogo from "@/main/inner_logo.png";
...
export const PieChart = () => {
  const donutData = {
    ...
    options: {
      ...
      //     const name = opts.w.config[opts.seriesIndex];
      //     return [name];
      //   },
      // },
      colors: ["#6787B7"],
